...
export const heroConfig: HeroConfig = {
  ...
  detailChips: ['Основано в 2014', 'Гимназия', 'Секции ГНОУ'],
};
...
export const sectionWindowConfig: SectionWindowConfig = {
  ...
  tabs: [
    ...
    },
    {
      ...
      title: 'Секции ГНОУ',
      description:
        'Филология, STEM, экология и иностранные языки работают как самостоятельные исследовательские траектории.',
      features: [
        {
          title: 'Филология',
          description: 'Лингвистика, литература, культурология, творческие и аналитические проекты.',
        },
        {
          title: 'Научно-техническая секция',
          description: 'Математика, информатика, физика, астрономия и техническое проектирование.',
        },
        {
          title: 'Юные химики и экологи',
          description: 'Практикумы, мониторинг среды, химические исследования и мини-экспедиции.',
        },
        {
          title: 'Иностранный язык',
          description: 'Языковые клубы, переводческие задачи и культурные презентации.',
        },
      ],
    },
    {
      ...
      description:
        'Работу ГНОУ координируют педагог и ученическое руководство, отвечающие за организацию секций и событий.',
      details: [
        'Руководитель: Гавриленко Арина Викторовна, учитель химии.',
        'Председатель: Виниченко Милана, учащаяся IX «А» класса.',
      ],
      features: [
        {
          title: 'Организация',
