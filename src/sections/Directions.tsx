...
const directions: Direction[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      { src: `${import.meta.env.BASE_URL}images/stem/pdf-extracted/2_p1_1.jpg`, alt: 'Диплом STEM 2' },
      { src: `${import.meta.env.BASE_URL}images/stem/pdf-extracted/2_p2_1.jpg`, alt: 'Диплом STEM 3' },
      { src: `${import.meta.env.BASE_URL}images/stem/pdf-extracted/3_p1_1.jpg`, alt: 'Диплом STEM 4' },
      { src: `${import.meta.env.BASE_URL}images/stem/pdf-extracted/3_p2_1.jpg`, alt: 'Диплом STEM 5'},
      ...
      { src: `${import.meta.env.BASE_URL}images/stem/pdf-extracted/5_p4_1.jpg`, alt: 'Диплом STEM 11' },
      { src: `${import.meta.env.BASE_URL}images/stem/pdf-extracted/5_p5_1.jpg`, alt: 'Диплом STEM 12' },
    ],
  },
  {
    id: 'young-chemists',
